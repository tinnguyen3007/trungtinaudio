...
Thông tin thêm [về plugin này](http://levantoan.com/lua-chon-tinhthanh-pho-vao-form-checkout-cua-woocommerce/).
Xem thêm bản PRO [tại đây](http://levantoan.com/plugin-tinh-phi-van-chuyen-cho-quan-huyen-trong-woocommerce/).

= 1.0.6 =

* Update: Chane .live to .on in jquery
